...
فرآیند تامین وابسته ها بسیار پیچیده هست یه گراف وابستگی ایجاد میشه ، مثلا در مثال پایین اگه خود `CatsService` نیازمند یه سری وابستگی باشه ، اول باید این وابستگی ها تامین بشه ، گراف وابستگی (**Dependency Graph**) این تضمین رو میده که وابستگی ها از  **پایین به بالا** تامین بشن.
...
- زمانی که می خواهید یک کلاس یکسان ، دارای دو توکن متفاوت باشد.
...
یه factory function ساده می تونه به provider های دیگه نیاز نداشته باشه و در مقابل یه factory function کمی پیچیده تر میتونه نیاز به provider هایی داشته باشه 
